models="Linear_AE"  # space separated names of models, find the whole list in main.py
...
do
    ...
    echo python3 main.py -i $graph -m $model -t 5 -n 10 -c 1 -s fast -p -l
    nice -n 10 python main.py -i $graph -m $model -t 5 -n 10 -c 1 -s fast -p -l
done
