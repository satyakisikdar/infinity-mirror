...
from evaluation import get_roc_score, clustering_latent_space, get_graph_from_emb
...
for i in range(FLAGS.nb_run):
    ...
    for epoch in range(FLAGS.epochs):
        ...
        # t = time.time()  # compute times for every 10 epochs
...
gen_graph = get_graph_from_emb(emb)
print(f'Generated graph n: {gen_graph.order()}, m: {gen_graph.size()}') 
